...
int main(int argc, char* argv[])
{
    ...
    const std::map<std::string, std::vector<std::string>> variables =
    {
        {"EventShapeVar", {"EvtNum_double",
                           ...
                           "jmt_ev2_top6",
                           "NGoodJets_double",
                           "Jet_pt_1",   "Jet_pt_2",   "Jet_pt_3",   "Jet_pt_4",   "Jet_pt_5",   "Jet_pt_6",   "Jet_pt_7",   "Jet_pt_8",   "Jet_pt_9",   "Jet_pt_10", 
                           "Jet_pt_11",  "Jet_pt_12",  "Jet_pt_13",  "Jet_pt_14",  "Jet_pt_15",  "Jet_pt_16",  "Jet_pt_17",  "Jet_pt_18",  "Jet_pt_19",  "Jet_pt_20",
                           "Jet_eta_1",  "Jet_eta_2",  "Jet_eta_3",  "Jet_eta_4",  "Jet_eta_5",  "Jet_eta_6",  "Jet_eta_7",  "Jet_eta_8",  "Jet_eta_9",  "Jet_eta_10",
                           "Jet_eta_11", "Jet_eta_12", "Jet_eta_13", "Jet_eta_14", "Jet_eta_15", "Jet_eta_16", "Jet_eta_17", "Jet_eta_18", "Jet_eta_19", "Jet_eta_20",
                           "Jet_phi_1",  "Jet_phi_2",  "Jet_phi_3",  "Jet_phi_4",  "Jet_phi_5",  "Jet_phi_6",  "Jet_phi_7",  "Jet_phi_8",  "Jet_phi_9",  "Jet_phi_10",
                           "Jet_phi_11", "Jet_phi_12", "Jet_phi_13", "Jet_phi_14", "Jet_phi_15", "Jet_phi_16", "Jet_phi_17", "Jet_phi_18", "Jet_phi_19", "Jet_phi_20",
                           "Jet_m_1",    "Jet_m_2",    "Jet_m_3",    "Jet_m_4",    "Jet_m_5",    "Jet_m_6",    "Jet_m_7",    "Jet_m_8",    "Jet_m_9",    "Jet_m_10",
                           "Jet_m_11",   "Jet_m_12",   "Jet_m_13",   "Jet_m_14",   "Jet_m_15",   "Jet_m_16",   "Jet_m_17",   "Jet_m_18",   "Jet_m_19",   "Jet_m_20",
                           "GoodLeptons_pt_1",
                           "GoodLeptons_eta_1",
                           "GoodLeptons_phi_1",
                           "GoodLeptons_m_1",
